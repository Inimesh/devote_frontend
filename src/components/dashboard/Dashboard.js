...
const Dashboard = (props) => {
  ...
  return (
    <div className="container-fluid p-sm-3">
      <div className="row">
        <div className="col-sm-2"><UserWindow className="user_window" userInfo={props.userInfo} handleLogout={props.handleLogout} transactions={props.transactions} receiverAccountInfo={props.receiverAccountInfo}/></div>
